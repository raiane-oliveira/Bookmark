...
export default function Header() {
  ...
  const headerElement = header.current as unknown as Element;

  function openBurgerMenu() {
    if (headerElement !== null) {
      headerElement.classList.toggle("active");
      document.body.style.overflow = headerElement.classList.contains("active")
        ? "hidden"
        : "initial";
    }
  }
  ...
  function handleClick() {
    if (headerElement !== null && headerElement.classList.contains("active")) {
  ...
  return (
    <header ref={header} className="header">
      ...
      <nav className="navigation-header">
        <a onClick={handleClick} href="#features">
          Features
        </a>
        <a onClick={handleClick} href="#extension">
          Extension
        </a>
